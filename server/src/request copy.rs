...
pub mod tests {
    ...
    use crate::request::{Request, HttpVerbs, Errors, RegexWrapper};
    ...
    fn it_parse_params_request(){
        ...
        let mut get_routes: HashMap<RegexWrapper, String> = HashMap::new();

        let regex = r"";
        let regex = Regex::new(regex).expect("Regex errada");


        get_routes.insert(RegexWrapper(regex), String::from("teste"));
